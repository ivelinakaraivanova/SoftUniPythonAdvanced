...
def get_word_from_file(file_path):
...
def get_words_counts(file_path, words):
    ...
    with open(file_path, 'r') as file:
        for line in file:
            words_in_line = get_word_from_text(line)
...
words_file_path = 'D:/Iva/Python Advanced/Materials/Exercises/08-File-Handling-Lab-Resources/Words Count/words.txt'
text_file_path = 'D:/Iva/Python Advanced/Materials/Exercises/08-File-Handling-Lab-Resources/Words Count/text.txt'

words_counts = get_words_counts(text_file_path, get_word_from_file(words_file_path))
